...
We want to take the catch and lengthed data and 
1. look up how many length samples are at each sampling event (station) and what proportion of the catch those represent

#1. proportion sampled/unsampled
...
table(test_a0_pcod_lng$lhs_code) # 
