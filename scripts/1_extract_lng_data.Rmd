...
# write.csv(pcod, "data/pcod_lengths_akfin_011526.csv")
...
pcod_sl_full %>%
  filter(length < 150 & length_type == "SL",
         ...
         !(sample_year %in% c(2019, 2025))) %>%
  complete(sample_year = 2006:2025) %>% # remove this line if you only want to include years that we decided to include data from.
